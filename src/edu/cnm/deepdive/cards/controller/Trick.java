...
public class Trick {
  ...
  public static void main(String[] args) {
    ...
    trick.swap();
    trick.summarize();
    // TODO Create an instance of Trick with a shuffled deck of cards.
    // TODO Split deck into discard (trash), red-influenced, and black-influenced piles.
    // TODO PICK a random number of cards between 0 (inclusive) and the size of the smaller pile
    // (inclusive), and swap that many cards between piles
    // TODO Summarize pile contents - number of red in red-influenced, number of black
    // in black-influenced, and contents of both piles
  }
